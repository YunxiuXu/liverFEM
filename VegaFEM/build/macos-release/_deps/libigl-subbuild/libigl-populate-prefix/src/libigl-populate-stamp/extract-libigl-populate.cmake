...
#
get_filename_component(filename "/Users/yunxiuxu/Documents/tetfemcpp/VegaFEM/build/macos-release/_deps/libigl-subbuild/libigl-populate-prefix/src/v2.4.0.zip" ABSOLUTE)
get_filename_component(directory "/Users/yunxiuxu/Documents/tetfemcpp/VegaFEM/build/macos-release/_deps/libigl-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libigl-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libigl-populate${i}")
